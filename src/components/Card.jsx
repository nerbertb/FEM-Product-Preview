function Card() {
  return (
    <div className="flex items-center justify-center place-content-center h-screen bg-[#F2EAE2]">
      <div className="card-component max-w-[350px]">
        <img
        ...
        <div className="bg-white p-8">
          ...
          <button className='flex justify-center items-center w-full bg-[#3D8168] hover:bg-[#1A4032] px-8 py-4 rounded-lg gap-2'>
            ...
            <p className='text-[14px]/[160%] text-white montserrat-bold'>Add to Cart</p></button>
        </div>
      </div>
    </div>
  );
